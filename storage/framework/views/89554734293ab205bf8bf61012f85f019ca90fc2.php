...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow card-default">
        ...
        <div class="card-header">
            <h4><?php echo e(isset($tag) ? 'Edit Tag' : 'Create Tag'); ?></h4>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(isset($tag) ? route('tags.update', $tag->id) : route('tags.store')); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="<?php echo e(isset($tag) ? $tag->name : ''); ?> <?php echo e(old('name')); ?>">
                </div>
